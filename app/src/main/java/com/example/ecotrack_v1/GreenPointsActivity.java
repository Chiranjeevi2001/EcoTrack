...
public class GreenPointsActivity extends AppCompatActivity {
    ...
    private void getUserGreenPoints() {
        FireBaseUtil.currentUserDetails().get().addOnCompleteListener(task -> {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(GreenPointsActivity.this, "Could not load the user details", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void shareGreenPoints(View view) {
        ...
        if (currentUser != null) {
            ...
            imagePath = saveImageToExternalStorage(imageBitmap);
            File imageFile = new File(imagePath);
            imageUri = FileProvider.getUriForFile(GreenPointsActivity.this, getApplicationContext().getPackageName() + ".provider", imageFile);
            Glide.with(GreenPointsActivity.this)
                    .load(imageUri)
    ...
    private Bitmap createImageWithGreenPoints(int greenPoints) {
        ...
        Bitmap logoBitmap = getBitmapFromDrawable(GreenPointsActivity.this, R.drawable.ecotracklogo);
    ...
    private String saveImageToExternalStorage(Bitmap bitmap) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            if (contentUri != null) {
                ...
                return getFilePathFromContentUri(GreenPointsActivity.this, contentUri);
            } else {
                return null;
            }
        } else {
